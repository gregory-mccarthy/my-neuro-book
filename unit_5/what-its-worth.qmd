...
![**Dopamine in an ancient action-modulation system.** **A.** In lamprey, an early-diverging vertebrate rather than a human ancestor, dopamine is embedded in circuits that transform sensory evidence and bodily state into action. An SNc/VTA-like dopaminergic population projects to both striatum and optic tectum, and some dopamine neurons branch to innervate both structures. Within striatum, dopamine increases the excitability of D1-enriched direct-like neurons and decreases the excitability of D2-enriched indirect-like neurons. These populations influence pallidal/nigral output, while dopamine also modulates tectal visuomotor circuitry; together, basal-ganglia and tectal pathways regulate access to orienting, avoidance, and locomotor systems. The lamprey evidence establishes an ancient receptor architecture and direct modulation of action-related circuits, not mammalian-style reward-prediction-error coding. **B.** Mammalian evolution elaborated this conserved scaffold by linking ventral, associative, and sensorimotor striatal territories with expanded cortical and pallial representations, amygdalar and hippocampal information, thalamic input, and insular and hypothalamic signals about bodily state. SNc/VTA dopamine neurons modulate these striatal gradients, while basal-ganglia outputs retain access to superior-collicular and brainstem systems controlling orienting, posture, gait, escape, feeding, and other actions. The expanded mammalian system therefore does not constitute a newly evolved “reward center”; it integrates richer information into an older architecture for selecting actions and changing how strongly they will be favored in the future. Blue arrows indicate dopaminergic projections, conventional arrowheads indicate excitatory projections, blunt-ended lines indicate inhibitory projections, and green and red symbols indicate increases and decreases in neuronal excitability, respectively.](/unit_5/figs/worth-evolution.jpeg){#fig-worth-evolution}
...
![**Prediction errors shift earlier with learning, while eligibility traces assign credit locally.** **A–C. Canonical dopamine-neuron response across learning.** **A.** Before learning, a new cue does not yet predict the outcome, and an unexpected reward produces a transient increase in dopamine-neuron activity. **B.** After learning, the earliest reliable cue produces the principal increase because it improves the forecast of future reward; delivery of the now-predicted reward produces little additional response. **C.** When the cue occurs but the expected reward is omitted, activity rises at the predictive cue and falls below baseline at the time the reward should have arrived. These responses resemble a signed reward-prediction error: activity increases when prospects improve, changes little when events match prediction, and decreases when the outcome is worse than expected. The curves show a canonical pattern observed in many midbrain dopamine neurons rather than a uniform response of every neuron or terminal field.  **D. Within one trial, brief local eligibility permits selective plasticity.** Context-related and action-related cortical inputs activate a subset of glutamatergic synapses on a striatal projection neuron. Coincident pre- and postsynaptic activity leaves those connections in a transient local eligibility state. A dopamine-related prediction-error signal arriving at the outcome can then alter the synaptic weights, $\Delta w$, of eligible connections while recently inactive connections undergo no lasting change. The direction and probability of plasticity depend on the sign and timing of the teaching signal, receptor and pathway identity, and the surrounding striatal circuit; the eligibility state should therefore not be interpreted as one identified molecule or as a label attached to the entire action. The lower timeline illustrates an eligibility window on the approximate scale of a second: dopamine arriving while eligibility remains elevated can support plasticity, whereas the same signal arriving after the trace has decayed is relatively ineffective.  **E. Across repeated trials, predictive significance appears at progressively earlier states.** Early in learning, the unexpected reward produces the largest positive prediction error. With experience, opening the container and seeing food becomes a nearer predictor of reward and produces the principal improvement in expectation. Once the sequence is well learned, the earliest reliable context or cue produces that improvement, while later predicted events add progressively less new information. The discrepancy therefore occurs earlier because learning changes the forecast at each state—not because a dopamine burst travels backward through time. Temporal-difference learning across repeated experiences and the short-lived synaptic eligibility trace within an individual trial solve complementary credit-assignment problems.](/unit_5/figs/worth-prediction-error.jpeg){#fig-worth-prediction-error}
...
![**Distributed learning across overlapping striatal territories and the ascending spiral.** **A.** The striatum contains partially overlapping territories with graded connectional biases rather than separate reward, associative, and motor compartments. Nucleus accumbens shell and core occupy the ventromedial end of the gradient, associative territories extend through anterior and dorsomedial caudate–putamen, and sensorimotor territories are biased toward posterior dorsolateral striatum. Broad projection fans indicate convergent inputs from hippocampus, medial prefrontal and orbitofrontal cortex, anterior cingulate cortex, insula, amygdala, thalamus, sensorimotor cortex, and hypothalamic or brainstem state systems. Darker and wider portions of a fan indicate a stronger projection bias; paler extensions emphasize overlap with neighboring territories. Ventral-striatal outputs converge prominently on ventral pallidum, which provides selected routes toward mediodorsal thalamic and frontal systems, hypothalamus, lateral-habenula-related and midbrain circuitry, and brainstem or orienting systems. Accumbens neurons also influence midbrain dopamine regions, making the network recurrent. The inset emphasizes that both D1-enriched and D2-enriched accumbens projection neurons contribute substantially to ventral-pallidal output; receptor class therefore does not define a clean dorsal-style direct–indirect division in ventral striatum. **B.** Overlapping striatal and midbrain territories form closed and open striato–nigro–striatal components. In each relatively closed component, a striatal territory influences dopamine neurons that project back to that territory. In the open components, striatal influence extends into adjacent dopamine populations whose projections reach the next, more dorsal and lateral striatal territory: from shell toward core, from core toward associative striatum, and from associative toward dorsolateral sensorimotor striatum. Black arrows indicate striatal influence on the midbrain, solid colored arrows indicate dopamine projections returning to the corresponding territory, and dashed colored arrows indicate nonreciprocal dopamine projections extending toward the next territory. The overlapping VTA, medial SNc, and lateral SNc fields are schematic rather than sharply bounded nuclei. Faint background connections represent additional cortical, thalamic, limbic, local, and recurrent basal-ganglia routes. The ascending spiral is therefore one pathway for coordinating plasticity across striatal territories, not a conveyor belt by which value is obligatorily transformed into habit.](/unit_5/figs/worth-spiral.jpeg){#fig-worth-spiral}
...
![**Behavioral tests distinguish goal-directed action from instrumental habit.** **A. Outcome devaluation.** During training, pressing lever A produces sucrose and pressing lever B produces a food pellet. One outcome is then selectively devalued, either by allowing the animal to consume it to satiety or, in an alternative procedure, by pairing its consumption with illness. Revaluation changes the outcome’s current incentive value without erasing the learned action–outcome relation. During a brief extinction test, both levers are available but neither outcome is delivered. Selective suppression of the action that previously produced the devalued sucrose, together with continued responding for the still-valued pellet, is an outcome-sensitive pattern and provides evidence for goal-directed control. Failure to suppress that action selectively is consistent with outcome-insensitive, habitual control, provided that devaluation was effective and the animal can still discriminate the two outcomes [@balleinedickinson1998goal].  **B. Causal-contingency test.** The illustrated omission schedule asks whether responding still depends on causing its consequence. After lever A has earned food, the rule is reversed: food is delivered only when the animal withholds the response, and pressing delays the outcome. Outcome-sensitive responding declines across successive test blocks, whereas outcome-insensitive responding persists at a comparatively high level even though the action now postpones or prevents food. Devaluation therefore tests sensitivity to what the outcome is currently worth, whereas omission tests sensitivity to whether the action still causes the outcome. No single negative result proves habit; appropriate controls must exclude ineffective revaluation, generalized illness, failed outcome discrimination, and other alternative explanations.  **C. Dorsal-striatal biases and relative influence.** Posterior dorsomedial striatum (pDMS, blue) and dorsolateral striatum (DLS, red) are depicted as bilateral, overlapping territories within posterior dorsal striatum. The pDMS has a stronger bias toward action–outcome and contingency-sensitive control, whereas the DLS has a stronger bias toward practiced sensorimotor and outcome-insensitive control. Extended practice can increase the relative influence of DLS, but pDMS continues to contribute, and the balance can shift again with changes in context, contingency, or circuit function. These territories are therefore concurrent components of a distributed network, not exclusive goal and habit modules joined by an irreversible handoff [@yinetal2004dls; @yinetal2005dms; @yinetal2006contingency; @gremelcosta2013shift].  **D. Sequence chunking.** Schematic DLS ensemble activity illustrates how practice can reorganize a learned sequence. Early in training, activity marks several turns or component actions; after extensive practice, activity can become especially prominent near sequence onset and termination, forming a neural “task bracket” around the intervening actions [@jogetal1999habits; @jincosta2010startstop]. Task bracketing concerns how a sequence is organized and executed as a unit; it is not by itself evidence that performance has become insensitive to outcome value or causal contingency. Goal-directed and habitual describe sources of behavioral control, not conscious versus unconscious, unskilled versus skilled, or slow versus fluent action. Bars and neural traces are schematic and do not represent measurements from a single experiment. ](/unit_5/figs/worth-devaluation.jpeg){#fig-worth-devaluation}
...
![**Learning, wanting, and liking can separate: multiple routes to persistent drug seeking.** **A.** Three operations normally cooperate within the same behavioral episode but can be dissociated experimentally. **Wanting** occurs when a learned cue interacts with the current bodily state to increase attention, motivational pull, action probability, and vigor. The same food cue, for example, exerts greater control during hunger than during satiety. Pavlovian–instrumental transfer provides an experimental demonstration: a cue first paired with an outcome can later invigorate an independently learned action during a test in which the outcome is not delivered. **Liking** is the positive hedonic reaction produced during consumption. Rodent taste-reactivity assays identify stereotyped positive and negative orofacial responses and reveal very small μ-opioid- and endocannabinoid-sensitive hedonic hotspots in medial nucleus accumbens shell and posterior ventral pallidum. These hotspots are causal nodes within a wider network, not pleasure centers. **Learning** updates future cue and action weights when the obtained outcome differs from the expected outcome. Better-than-expected, expected, and worse-than-expected outcomes generate signed prediction-error signals that can strengthen or weaken eligible corticostriatal connections. Midbrain dopamine, arising from the substantia nigra pars compacta and ventral tegmental area, contributes strongly to learning and cue-triggered wanting but is not a general pleasure signal. Thus, learning changes future weights, wanting gives cues and outcomes motivational control over present action, and liking is the hedonic reaction during consumption. **B.** Persistent drug seeking can emerge through several nonexclusive routes whose relative importance depends on the drug, person, stage of use, internal state, and environment. First, drugs act through different primary pharmacological targets: cocaine and amphetamine alter monoamine transporters, opioids act at opioid receptors across multiple systems, nicotine activates nicotinic acetylcholine receptors, and alcohol affects several transmitter and membrane mechanisms. These distinct actions can dysregulate learning and motivation, and many addictive drugs also alter mesolimbic dopamine signaling. Second, drug-predictive cues can acquire unusually strong motivational control. Their effects interact with stress and current bodily state and may increase attention, craving, approach, and pursuit without a corresponding increase in liking. Third, repeated seeking can, in some circumstances, recruit progressively more dorsal striatal control, from ventral striatum and dorsomedial striatum toward dorsolateral sensorimotor circuitry, making behavior relatively insensitive to outcome devaluation or contingency change. This transition is conditional rather than inevitable and does not define addiction. Fourth, drug use can be maintained by **negative reinforcement** when it relieves withdrawal, stress, dysphoria, or pain; relief then increases the probability of future seeking. These routes can converge on persistent drug seeking or use. The matrix at right distinguishes **habit**, defined by relative insensitivity to outcome value, from **compulsion**, defined by persistence despite punishment, conflict, or known harm. Either can occur without the other, although they may overlap. Addiction therefore reflects different mixtures of altered learning, cue-triggered wanting, habitual control, relief from aversive states, and persistence despite harm; no single brain region, dopamine transient, or habit measure defines the disorder.](/unit_5/figs/worth-liking-wanting.jpeg){#fig-worth-liking-wanting}
