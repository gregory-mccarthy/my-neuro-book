...
![**Cone contrast and early opponent channels.** Cone signals are first expressed relative to an adapted background as cone contrasts: \(c_L = (L-L_0)/L_0\), \(c_M = (M-M_0)/M_0\), and \(c_S = (S-S_0)/S_0\). These normalized inputs are then combined schematically to form three post-receptoral channels: a luminance-related achromatic signal, \(\approx w_L c_L + w_M c_M\); an \(L\)-versus-\(M\) signal, \(\approx a c_L - b c_M\); and an \(S\)-versus-\((L+M)\) signal, \(\approx c c_S - (d c_L + e c_M)\). The weights indicate that biological circuits need not combine cone classes equally. Worked examples show the expected pattern of responses for three simplified changes from a neutral gray background: a broadband increment, which strongly drives the achromatic channel while leaving opponent signals relatively small; an \(L\)-biased change, which shifts the \(L\)-versus-\(M\) channel toward the \(L\)-dominant side; and an \(S\)-biased change, which shifts the \(S\)-versus-\((L+M)\) channel toward the \(S\)-dominant side. The figure is schematic and emphasizes that early retinal channels encode relations among cone signals rather than directly identifying wavelength or color.](/unit_4/figs/cone-contrast.jpeg){#fig-vision01-cone-contrast}
...
![**Foveal private lines and peripheral convergence across retinal eccentricity.** **Top:** schematic photoreceptor density as a function of retinal eccentricity, showing the sharp cone peak in the central fovea, the rod-free foveola, the rise of rod density outside the center to a parafoveal peak, and the optic-disc gap. **Middle:** near the fovea, a single cone can supply parallel ON and OFF midget pathways, preserving single-cone input through cone → midget bipolar → midget ganglion “private lines,” which support small receptive-field centers and high spatial acuity. **Bottom:** with increasing eccentricity, rods become abundant and convergence increases, so multiple photoreceptors pool onto bipolar and ganglion cells, producing larger receptive fields that improve sensitivity to weak signals at the cost of spatial precision. The figure summarizes a graded tradeoff across the retina: the fovea is specialized for fine detail under adequate illumination, whereas the peripheral retina is specialized for wide-field monitoring, weak-signal detection, and guiding eye movements.](/unit_4/figs/fovea-periphery.jpeg){#fig-vision01-fovea-periphery}
...
![**Parallel retinal outputs.** Selected retinal ganglion-cell populations transmit different transformations of the visual input. **Midget ganglion cells** have especially small receptive fields near the fovea, support high spatial resolution, and often carry L-versus-M cone-opponent signals in central retina; they provide the major retinal input to the **parvocellular layers of the lateral geniculate nucleus (LGN)**. **Parasol ganglion cells** have larger receptive fields, high contrast sensitivity, and relatively rapid, often transient responses to broadband luminance signals; they provide the major retinal input to the **magnocellular LGN** but should not be treated as dedicated motion detectors. **Small-bistratified ganglion cells** carry a prominent **S-ON/(L+M)-OFF** chromatic signal and provide an important input to **koniocellular LGN regions**, which also receive signals from other retinal cell types. **Intrinsically photosensitive retinal ganglion cells (ipRGCs)** combine melanopsin phototransduction with rod and cone input to represent sustained irradiance and project to the suprachiasmatic nucleus and other hypothalamic circadian targets, pretectal pupil-control circuits, and additional brain regions. Numerous **additional specialized ganglion-cell types** signal properties such as direction, local boundaries, and image shift and project to the LGN, superior colliculus, accessory optic system, and other targets. Receptive-field sizes and temporal profiles are schematic and vary with retinal eccentricity, cell subtype, stimulus conditions, and species. Retinal cell names such as *midget*, *parasol*, and *small-bistratified* should not be equated with the parvocellular, magnocellular, and koniocellular divisions of the LGN.](/unit_4/figs/ganglion-cells.jpeg){#fig-vision01-gnaglion-cells}
