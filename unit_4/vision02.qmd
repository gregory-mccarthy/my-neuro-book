...
![**Sorting visual hemifields at the optic chiasm.** Because the optics of the eye reverse the image, each visual hemifield projects onto opposite anatomical halves of the two retinas. **A,** The left visual hemifield (blue) falls on the nasal hemiretina of the left eye and the temporal hemiretina of the right eye. Axons from the left nasal hemiretina cross at the optic chiasm, whereas axons from the right temporal hemiretina remain uncrossed; both sets therefore enter the right optic tract and continue toward the right lateral geniculate nucleus (LGN) and right visual cortex. **B,** The right visual hemifield (red) falls on the temporal hemiretina of the left eye and the nasal hemiretina of the right eye. Axons from the right nasal hemiretina cross at the chiasm, whereas axons from the left temporal hemiretina remain uncrossed; both sets enter the left optic tract and continue toward the left LGN and left visual cortex. Solid and dashed lines distinguish axons arising from the left and right eyes, respectively; pale gray pathways indicate the tract not carrying the illustrated hemifield. Thus, each optic nerve carries output from one eye, whereas each optic tract carries information principally about the contralateral visual hemifield. The diagram is schematic and omits upper–lower retinal inversion, the monocular crescent, and finer anatomical organization near the vertical meridian.](/unit_4/figs/chiasm.jpeg){#fig-vision02-chiasm}
...
![**One optic tract, several visual targets.** Retinal ganglion-cell axons leave the eye through the optic nerve, undergo partial decussation at the optic chiasm, and continue in the optic tract. The principal **geniculostriate pathway** projects to the **lateral geniculate nucleus (LGN)**, whose relay neurons send axons through the **optic radiations** to **primary visual cortex (V1)**; this is the main route for detailed pattern vision. Smaller retinal projections also reach the **pretectal region** (pupillary light reflex), the **superior colliculus** (orienting and eye/head movements), **hypothalamic targets including the suprachiasmatic nucleus, SCN** (circadian entrainment), and **accessory optic nuclei** (image stabilization during self-motion). **Intrinsically photosensitive retinal ganglion cells (ipRGCs)** contribute strongly to several non-image-forming targets and also project to the LGN. Dashed arrows indicate selected interactions among **V1**, **LGN**, **pulvinar**, and **superior colliculus**, emphasizing that these branches are anatomically and functionally interconnected rather than fully independent image pathways. The figure is schematic and is intended to highlight the dominance of the retina → LGN → V1 route while retaining major subsidiary visual targets.](/unit_4/figs/visual-pathways.jpeg){#fig-vision02-visual-pathways}
...
![**Major magnocellular, parvocellular, and koniocellular relationships in the primate lateral geniculate nucleus.** The schematic depicts the six principal layers of the macaque LGN. Layers 1 and 2 constitute the magnocellular division, whereas layers 3 through 6 constitute the parvocellular division. Koniocellular neurons form heterogeneous populations within thin interlaminar and related zones. Each principal layer receives dominant retinal input from one eye: layers 1, 4, and 6 from the contralateral eye and layers 2, 3, and 5 from the ipsilateral eye. A highlighted retinotopic column shows that corresponding positions in the stacked layers represent approximately the same location in the contralateral visual hemifield. **Parasol retinal ganglion cells** provide a major input to magnocellular layers, midget ganglion cells provide a major input to parvocellular layers, and small-bistratified cells provide one important S-cone-related input to koniocellular circuitry. These relationships are biases rather than strict correspondences: additional retinal cell types contribute to the LGN, and the koniocellular system is especially heterogeneous. Magnocellular neurons tend to have larger receptive fields, high luminance-contrast sensitivity, and relatively rapid, transient responses; parvocellular neurons tend to have smaller receptive fields, higher spatial resolution, more sustained responses, and frequent L-versus-M cone opponency; and koniocellular populations have diverse response properties, with S-cone-related signals prominent in some subdivisions. **LGN relay neurons** project to primary visual cortex, while feedback from layer 6 of V1 and inputs from the thalamic reticular nucleus, brainstem, and other state-regulating systems modulate geniculate activity. Although the principal retinal drive remains segregated by eye of origin, stimulation of the nondominant eye can suppress or otherwise modulate LGN responses, demonstrating binocular interaction before the principal cortical convergence [@DoughertyEtAl2021]. The M, P, and K divisions should therefore not be equated with dedicated “motion,” “form,” or “color” channels; they provide differently weighted inputs that are recombined in subsequent cortical computations. The detailed laminar arrangement shown here is based principally on macaque anatomy; the human LGN shares the broad M, P, and K organization but differs in its folding and internal subdivisions.](/unit_4/figs/visual-lgn.jpeg){#fig-vision02-visual-lgn}
...
![**Optic radiations carry the visual map to V1.** **A,** Relay-cell axons leave the left lateral geniculate nucleus (LGN) and fan through the cerebral white matter as the optic radiations, or geniculocalcarine pathway. Information from the right upper visual field, which falls on inferior retinal locations in both eyes, travels through the ventral temporal component of the radiation. These fibers sweep anteriorly around the temporal horn in Meyer’s loop before turning posteriorly to terminate in the lower bank of the calcarine sulcus. Information from the right lower visual field, which falls on superior retinal locations, follows a more direct dorsal route through parietal white matter to the upper calcarine bank. The pale background fan represents the broader optic radiation; blue and pink highlight the upper- and lower-field components, respectively. Dashed outlines indicate that the anterior extent of Meyer’s loop varies substantially among individuals, an important consideration in temporal-lobe surgery [@NilssonEtAl2007; @PowellEtAl2005]. **B,** Retinotopy is preserved within V1 along two dimensions. Upper and lower portions of the contralateral visual field are represented on the lower and upper banks of the calcarine sulcus, respectively. Eccentricity is organized approximately along the posterior–anterior axis: central and foveal vision occupies posterior cortex near the occipital pole, whereas progressively more peripheral locations extend anteriorly. The diagram is schematic and does not depict cortical magnification or the full complexity introduced by cortical folding. **C,** Predicted visual-field deficits follow the organization of the radiations. A lesion of the left temporal radiation, including Meyer’s loop, preferentially interrupts upper-field fibers and produces a right superior homonymous quadrantanopia. A lesion of the left parietal radiation preferentially interrupts lower-field fibers and produces a right inferior homonymous quadrantanopia. A sufficiently large lesion involving both components can produce a right homonymous hemianopia. Red marks the site of pathway injury, and gray shading marks the portion of the visual field lost in both eyes. The sharply bounded defects shown here are idealized; actual deficits vary with lesion size, location, and individual anatomy.](/unit_4/figs/visual-radiations.jpeg){#fig-vision02-radiations}
...
![**Major geniculate inputs enter different V1 sublayers.** This simplified macaque circuit shows the principal laminar entry points of geniculocortical input and selected routes through primary visual cortex. Magnocellular input (blue) terminates principally in layer 4Cα, whereas parvocellular input (red) terminates principally in layer 4Cβ. Koniocellular pathways (green) are more heterogeneous; representative projections are shown reaching layer 1, superficial cortex—including a cytochrome-oxidase-rich blob within layers 2/3—and layer 4A. The colored afferents end at these cortical entry points rather than continuing as isolated channels through the cortex. Gray arrows represent simplified intracortical relays and recurrent connections. Layer 4Cα strongly influences layer 4B and superficial circuits, while layer 4Cβ projects into the superficial layers. Horizontal and recurrent interactions within layers 2/3 and 4B permit magnocellular-, parvocellular-, and koniocellular-related signals to converge. Solid black arrows indicate major feedforward outputs: layers 2/3 project extensively to V2 and other extrastriate visual areas, and layer 4B contributes both a direct route to motion-related cortex, MT, and an indirect route through the thick-stripe system of V2. Dashed arrows show extrastriate feedback to superficial and deep V1 layers. A separate projection from layer 6 provides corticogeniculate feedback to the LGN. The routes shown are selective and schematic rather than exhaustive; the central point is that M, P, and K pathways have biased cortical entry zones but do not remain segregated within the recurrent circuitry of V1.](/unit_4/figs/v1-layers.jpeg){#fig-vision02-v1-layers}
...
![**From local contrast to orientation.** **A,** Representative ON-center and OFF-center lateral geniculate nucleus (LGN) receptive fields are arranged so that their centers lie along parallel lines in visual space. Excitatory thalamocortical afferents from receptive fields of the same response polarity converge onto corresponding elongated subregions of a schematic V1 simple-cell receptive field, here illustrated with an OFF–ON–OFF organization. The plus and minus signs indicate whether a luminance increment or decrement within the receptive-field center increases firing; they do not indicate excitatory versus inhibitory synaptic transmission. A vertical light bar positioned over the central ON subregion activates several spatially aligned inputs together and produces a strong response. The same bar rotated to the orthogonal orientation crosses both ON and OFF subregions and produces less net drive. Only a representative subset of the many thalamic and cortical inputs to a real V1 neuron is shown. Paired recordings support the construction principle that geniculate neurons connected to the same simple cell tend to occupy positions matching the cell’s elongated subregions [@ReidAlonso1995; @AlonsoEtAl2001]. **B,** Spatially arranged feedforward input provides an initial orientation bias, shown here as a schematically broad tuning curve. Local recurrent excitation and inhibition, nonlinear synaptic integration and spike threshold, normalization and suppression, and contextual influences from outside the classical receptive field can alter response gain and tuning width. Feedback from extrastriate areas such as V2 and V3 contributes to some forms of surround suppression and end-stopping [@RingachEtAl2002; @NassiEtAl2013]. The narrower output curve is an illustrative example rather than a universal transformation: the relative contributions of feedforward, recurrent, and feedback mechanisms vary across neurons, cortical layers, stimuli, and behavioral conditions. Aligned thalamic input therefore helps establish orientation preference, while cortical circuitry and visual context shape the response ultimately measured.](/unit_4/figs/v1-orientation.jpeg){#fig-vision02-v1-orientation}
...
![**Simple, complex, and end-stopped responses.**  Three aligned panels summarize classical response properties described in primary visual cortex. **A, Simple responses.** A simple cell has spatially distinct ON and OFF subregions, here illustrated for a neuron that prefers a vertical stimulus. Because the arrangement of light and dark must match those subregions, the response depends on **spatial phase**: a preferred grating phase produces a strong response, whereas a half-cycle shift markedly reduces firing. During drift of the preferred grating, firing rate is strongly modulated in step with the repeating light–dark pattern. **B, Complex responses.** A complex cell remains selective for orientation but is less dependent on the exact phase or position of the stimulus within the receptive field. One useful introductory model pools several simple-cell-like inputs that share orientation preference but differ in phase or position, followed by a nonlinearity. As a result, the neuron responds strongly to the preferred orientation across a broader range of positions or phases, and responses to a drifting grating are less strongly phase-locked. Many complex cells also show direction selectivity, but direction preference is not what defines the simple–complex distinction. **C, End-stopped responses.** Some orientation-selective neurons respond best to a bar of limited length. As bar length increases, firing rises while the stimulus occupies the central excitatory region, reaches a maximum at an optimal length, and then falls as the bar extends into suppressive end zones. End-stopping can occur in simple-like or complex-like neurons and may contribute to population coding of contour endings, curvature, and junctions. The three panels should be understood as describing overlapping response dimensions rather than three obligatory serial anatomical stages.](/unit_4/figs/v1-complex.jpeg){#fig-v1-complex}
...
![**Binocular disparity from retinal geometry to cortical reference frames.** **A, Geometry and retinal correspondence.** The eyes fixate the green point, whose images fall on the two foveae and therefore have zero disparity. Other points on the schematic horopter also project to corresponding retinal locations. For the centered examples shown here, an object nearer than fixation—the blue square—projects to temporal retinal locations in both eyes and produces crossed disparity. An object farther than fixation—the red triangle—projects to nasal retinal locations and produces uncrossed disparity. The retinal strips show only the horizontal dimension and are not anatomical cross-sections. **B, Disparity-selective responses in V1.** Left- and right-eye signals remain largely segregated through eye-specific LGN channels and territories in layer 4C before their effective convergence within V1. The example binocular neuron responds most strongly when a feature occupies a particular pair of horizontally offset locations in the two eyes. Its idealized tuning curve peaks at a preferred crossed disparity. The diagram represents functional input alignment rather than a complete literal synaptic circuit; real disparity tuning arises from multiple receptive-field mechanisms and nonlinearities. Crossed disparities are plotted as negative and uncrossed disparities as positive, although sign conventions vary. **C, From absolute toward relative disparity.** V1 populations represent predominantly absolute disparity—the disparity of a feature relative to the current fixation geometry. Sensitivity to the disparities of neighboring features increases in V2, and relative-disparity coding becomes more prominent in V4 and other extrastriate areas. In the example at right, changing fixation from object B to object A changes the absolute disparities of both objects, but their difference, $$Delta d=d_A-d_B$$, remains constant. Relative disparity therefore provides a representation of depth relationships that is less dependent on the exact fixation point. These cortical distinctions are graded rather than sharply separated stages. Closing one eye removes the comparison between simultaneous retinal images and thus ordinary binocular disparity, but leaves other depth cues—including occlusion, relative size, perspective, texture gradients, shading, motion parallax, accommodation, and learned object scale—available.](/unit_4/figs/v1-disparity.jpeg){#fig-vision01-v1-disparity}
...
![**Color signals are transformed in V1.** **A,** Cone-opponent signals inherited from the retina and LGN can be combined across space to create double-opponent receptive fields. In the idealized example, one receptive-field subregion is excited by L-cone increments and inhibited by M-cone increments, whereas the adjacent subregion has the opposite weighting. A matched-luminance chromatic boundary aligned with these subregions drives both portions of the receptive field in the excitatory direction and produces a strong response. A spatially uniform L-cone-favoring field excites one subregion while opposing the other, yielding a weak or near-baseline response in the idealized balanced neuron. Recorded double-opponent receptive fields vary in size, shape, balance, and cone weighting, and uniform chromatic fields can activate other V1 neurons; the diagram illustrates how spatially organized cone opponency can contribute specifically to signaling chromatic contrast across space. S-cone versus L+M signals can participate in analogous combinations. **B,** Tangential schematic of superficial V1, approximately layers 2/3. Gray patches represent cytochrome-oxidase blobs, colored line segments represent the local orientation-preference map, and orange regions represent domains with enhanced chromatic responses. Responses to spatially uniform chromatic fields tend to be concentrated near blobs, whereas responses to spatially structured chromatic contrast can extend beyond blob borders into interblob cortex. Orientation selectivity is lower on average near blobs but remains present, while stronger orientation selectivity is more common between blobs. Blobs are therefore chromatic enrichments within overlapping cortical maps rather than exclusive color modules. V1 supplies retinotopically organized chromatic and luminance structure that is further integrated through recurrent interactions with V2, V4-region circuitry, and other ventral visual areas to support the representation of surfaces, illumination, objects, perceived hue, and color constancy. Colors denote cone contrast and functional organization, not one-to-one neural codes for experienced red, green, or other hue categories. Schematics are not to scale.](/unit_4/figs/v1-color.jpeg){#fig-vision01-color}
...
![**Overlapping maps and compartments in primate V1.** The panels show the same schematic cortical coordinates separately and in register. **(A)** Preferred orientation changes continuously across the cortical surface, represented here by cyclic false color spanning 0–180°. Because orientation is an axis rather than a direction, orientations separated by 180° are equivalent. Black dots mark orientation singularities, or pinwheel centers, around which the full range of preferred orientations is encountered. **(B)** Relative eye preference, shown most prominently in layer 4C, varies across irregular alternating bands. Blue indicates greater influence from the left eye, orange indicates greater influence from the right eye, and pale regions indicate more nearly balanced input; these are relative biases and do not imply that neurons within a band are exclusively monocular. **(C)** Cytochrome-oxidase-rich blobs form irregular supragranular compartments. In macaque V1, blobs tend to occur near the midlines of ocular-dominance bands, represented here by the dashed blue and orange lines, although the relationship is statistical rather than a rigid one-to-one alignment. **(D)** The three organizations are superimposed as a conceptual registration. They overlap, interact, and have different spatial periodicities; pinwheel centers, eye-preference bands, and CO-rich blobs should therefore not be interpreted as identical repeated modules. The corner brackets mark a historical hypercolumn-sized sampling window—a local region containing a broad range of orientation preferences and input from both eyes for a small region of visual space—not an anatomical boundary. Horizontal intracortical connections extend through and beyond this window. The laminar inset emphasizes that CO-rich blobs are most conspicuous in superficial layers, eye-specific segregation is strongest in layer 4C, and orientation tuning varies with cortical depth. Only three of the many response dimensions represented in V1 are shown. The figure is a conceptual synthesis based mainly on macaque data, not a single histological section or a literal stack of bounded cortical tiles.](/unit_4/figs/v1-overlap.jpeg){#fig-vision02-v1-overlap}
...
![**V2 compartments have graded functional biases and feed into reciprocal dorsal and ventral visual networks.(A)** Schematic flattened view of macaque V2 showing the repeating cytochrome-oxidase stripe pattern: pale interstripe, thin stripe, pale interstripe, thick stripe, with the sequence repeating across cortex. The matrix below the stripe pattern summarizes **qualitative enrichment** rather than exclusive function. Thin stripes show the strongest bias for color and surface relationships; thick stripes show the strongest bias for binocular disparity and motion-related processing; and pale interstripes show the strongest bias for orientation, contour, and form. All three functional classes are represented in all stripe types, emphasizing that V2 compartments are **biased but overlapping** rather than sharply segregated modules. The miniature V1–V2 schematic at left indicates that the stripe pattern is shown as a schematic flattened view and is not to scale. **(B)** Simplified network diagram showing that dorsal- and ventral-biased visual pathways are **reciprocal and cross-connected**. Ascending input proceeds from retina to LGN and then to V1; M-, P-, and K-related geniculate signals converge before and within cortical circuits. V1 and V2 communicate bidirectionally. From V2, preferential but nonexclusive routes lead toward dorsal-biased circuitry, including V3, MT, and posterior parietal cortex, and toward ventral-biased circuitry, including V4 and ventral temporal cortex. MT is emphasized as a node specialized for motion, binocular disparity, and changing spatial relationships, whereas V4 is emphasized as a node specialized for color, contour, curvature, texture, and surface relationships. Reciprocal connections between MT and V4, and between dorsal and ventral downstream regions, illustrate that the two broad networks are not independent streams. The inset at right shows approximate lateral-surface locations of the labeled macaque cortical areas; it is intended for anatomical orientation only and does not depict the pathways themselves. Stronger line weight indicates emphasized or preferential routes, whereas dashed lines indicate indirect or secondary routes.](/unit_4/figs/v2-stripes.jpeg){#fig-vision02-v2-stripes}
