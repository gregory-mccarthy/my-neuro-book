...
This makes pain a particularly clear demonstration of a principle that applies throughout the sensory systems. Sensing is not a neutral recording stage followed later by valuation and action. Sensory pathways are organized around what information means for the animal. Pain makes that organization unusually explicit because information about tissue threat arrives already coupled to urgency and aversion.

The chapter therefore begins with nociceptors and the fast and slow afferents that carry their signals. It then follows those signals into a distributed central system, examines the descending circuits that regulate them, and considers what happens when pain persists or appears to become uncoupled from immediate tissue damage.
...
A brief noxious stimulus to the skin can produce two successive sensations carried predominantly by different peripheral afferents.
...
*Figure 4.2.1. First and second pain after a brief cutaneous stimulus. Faster myelinated Aδ afferents support an early, sharp, relatively well-localized sensation; slower unmyelinated C fibers support a later, burning or aching sensation. The diagram represents a useful experimental case, not the temporal form of every pain experience.*
...
## From the spinal cord to a distributed pain system

The distinction between Aδ and C fibers should not be converted into a diagram with two peripheral wires ending in two cortical destinations. Once nociceptive afferents enter the dorsal horn, their activity is transformed by local excitatory and inhibitory circuits and distributed through several ascending routes.

The **spinothalamic pathway** carries information toward lateral and medial regions of the thalamus. Other projections reach the reticular formation and intralaminar thalamus, contributing to arousal and attention. The **spinoparabrachial pathway** reaches the parabrachial complex and, through it, hypothalamic and amygdalar systems that organize autonomic and defensive responses. Brainstem pathways also engage the periaqueductal gray and other structures that participate in both protective action and feedback control [@motzkin2024neuroanatomy].
...
Lateral thalamic projections to **primary and secondary somatosensory cortex** and posterior insular-opercular regions contribute strongly to the sensory-discriminative dimension. Medial and intralaminar thalamic projections to **cingulate**, anterior insular, prefrontal, and related regions contribute strongly to affective, attentional, and motivational processing. The emphasis differs across regions, but the functions are not divided into one cortical area that detects pain and another that contains suffering.
...
### Pain at the boundary of sensation and interoception
...
Insular, cingulate, hypothalamic, amygdalar, thalamic, and brainstem systems link nociceptive signals to bodily regulation and action. The overlap does not require a single cortical "home" for pain, emotion, and the viscera. It reflects the fact that these systems solve related control problems: estimating the state of the body, assigning biological importance, and selecting an appropriate response.

Pain therefore sits at a boundary. It is information about an event at or within the body, but it is also a regulated state that changes what the animal is prepared to do.
...
Central representations also persist. Studies of established amputees have found organized activity associated with movement of the missing hand, but cross-sectional associations between that activity and phantom pain cannot show what changed after amputation or whether the cortical activity causes the pain [@makin2017stability; @makin2023against]. More decisive longitudinal evidence comes from three adults scanned before and for as long as five years after planned arm amputation. Their hand and lip representations remained stable, with no evidence of large-scale invasion of the hand territory by the face [@makin2025stable].

The older claim that phantom pain is caused by neighboring body parts taking over the missing limb's cortical territory is therefore not a secure general explanation. Peripheral ectopic activity, residual-limb pathology, spinal and thalamic changes, and persistent cortical body representations may each contribute, with different weight across individuals. Phantom pain is real, but its mechanisms are probably heterogeneous.
...
Pain begins with receptors and afferent fibers, but its central organization is distributed. Nociceptive signals are transformed in the spinal cord, fanned into sensory, autonomic, affective, attentional, and motor systems, and continually regulated by descending control. Fast and slow afferents provide different temporal components; central circuits locate the threat, assign urgency and unpleasantness, and organize protection.

Sensitization, chronic pain, and phantom pain show how an adaptive control system can become persistent or partly uncoupled from its original trigger. Congenital pain insensitivity shows the opposite failure: without sufficient aversive signaling, the body cannot protect itself. Pain is therefore neither a simple damage meter nor an arbitrary construction. It is a regulated biological state in which sensation, valuation, and action are inseparable.

The unit now turns toward vision and hearing. These distance senses extend the spatial and temporal horizon of control, allowing events to guide behavior before they reach the body. The same principle will remain in force: sensory systems do not merely describe the world; they extract the information needed to act within it.
...
The durable lesson is not “two pains, two pathways, two destinations.” It is that nociceptive signals enter a distributed control system that estimates threat, regulates gain, and organizes protective action. The system is adaptive precisely because it is modifiable—and vulnerable precisely for the same reason.
:::
