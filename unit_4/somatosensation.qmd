...
encoding its unpleasantness. Note that the insular and cingulate projections arise from separate thalamic relays rather than a shared one. Only the S1 route concerns us here; the interoceptive and affective streams, along with a further pathway that reaches the amygdala without passing through the thalamus at all, are taken up in @sec-pain. Because decussation occurs in the cord, a spinal lesion produces contralateral loss of pain and temperature beginning one or two segments below the lesion, in contrast to the ipsilateral loss of fine touch that follows a dorsal-column lesion.](/unit_4/figs/anterolateral-partial.svg){#figs-somatosensation-anterolateral-partial}
