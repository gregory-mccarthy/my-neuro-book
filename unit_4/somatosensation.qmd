...
The shared sensory architecture developed in the overview is assumed here: physical energy is transduced at receptors, information is carried through ordered neuronal populations, the ascending pathways cross the midline, and thalamic relays project into mapped cortical fields embedded in recurrent networks. The task of this chapter is to specify how the body senses instantiate that plan—and to examine one place where the familiar textbook account has come under serious challenge.

This chapter concentrates on **touch** and **proprioception**. Pain and temperature receive their own treatment in the next chapter. Its conceptual burden is different. Pain is not simply a description of what is happening to the body; it is an aversive valuation that commands action. The peripheral and spinal hardware must therefore be introduced here before the experience of pain can be considered on its own terms.
...
## Receptors and molecular transduction
...
That detail matters here because it makes the muscle spindle a concrete instance of the book's central claim about the brain. Proprioceptive afferents are among the primary sensors in the feedback loops that regulate movement: they report the controlled variable—limb configuration—back to the circuits that command it, and the gamma system quietly tunes those sensors as the command changes. The stretch reflex, met later in this chapter, is the shortest such loop, closing entirely within the spinal cord; the spinocerebellar pathways carry the same information to the cerebellum for finer online regulation. Movement is the domain where this feedback architecture is developed in full, in Unit 5, where the spindle and its gamma control return as working parts of the motor system rather than as items in a receptor catalogue. It is introduced here because the receptor itself already embodies the principle: much of somatosensation exists not to inform awareness but to close control loops.
...
The circuit is more than a simple wire. Interneurons coordinate the response by inhibiting antagonist muscles and distributing activity across motor pools. Even the most elementary reflex therefore contains an organized relationship between sensory input and motor output. It is homeostatic control in miniature: detect a deviation, compare it with the circuit's operating state, and recruit an opposing action.

The cord also contains **central pattern generators (CPGs)** capable of producing rhythmic motor patterns. Under appropriate conditions, spinal circuitry below a transection can generate coordinated stepping movements when the limbs encounter a moving treadmill. Sensory feedback shapes the timing and force of the pattern, but the rhythm does not have to be specified step by step by the brain.

The spinal cord is therefore not merely a cable connecting body and brain. It contains local sensorimotor circuits and motor programs. Their fuller treatment belongs in the unit on movement, but their presence here follows directly from a sensory system designed for rapid action.
...
*Figure 4.1.4. The sensory homunculus across the postcentral gyrus: the body represented in medial-to-lateral order, with the leg and foot near the midline and the face laterally. The figure is best paired with the adjacent motor homunculus across the central sulcus. [Figure to source or redraw.]*
...
The somatosensory homunculus invites a natural inference: a body map this orderly must be permanently hard-wired. A long tradition of research instead described adult cortical maps as highly plastic. More recent work has challenged the strongest version of that account. The disagreement is not simply whether cortex can change, but what kind of change should count as a reorganized map.

### Evidence that the map is plastic

Several influential findings supported the classical remapping account:

- **Developmental specification by input.** In a classic transplantation experiment, late-embryonic visual cortex placed into neonatal somatosensory cortex developed barrel-like units characteristic of rodent whisker cortex [@schlaggar1991potential]. Developing cortical tissue therefore has substantial capacity to acquire features associated with the input and local environment it receives. The experiment does not show that all cortical areas are interchangeable, but it demonstrates that cortical identity is not specified entirely in advance.
- **Digit amputation in adult monkeys.** After a finger was amputated, Merzenich and colleagues found that cortical responses driven by neighboring fingers expanded into territory formerly associated with the missing digit [@merzenich1984digit]. The deprived territory did not simply become silent.
- **Long-term deafferentation.** Pons, Kaas, and colleagues reported that, years after an arm had been deafferented, stimulation of the face drove neurons in a large region formerly associated with the hand and arm [@pons1991massive]. The face and hand are neighbors in the cortical map, making the finding appear to show large-scale invasion of deprived territory.
- **Referred sensations in phantom limbs.** Ramachandran reported that touching parts of the face could evoke sensations referred to a phantom hand after amputation [@ramachandran1998phantom]. The phenomenon fit naturally with the proposal that facial input had gained access to the neighboring hand representation.

Together, these findings produced an elegant account: deprivation leaves cortical territory available, neighboring inputs expand into it, and phantom sensations reveal the perceptual consequences of that takeover. For several decades, that account became the standard demonstration that adult cortical maps can reorganize dramatically after injury.

### Evidence that the map is stable

Makin, Bensmaia, and colleagues have argued that the classical account often confused a change in measured responses with replacement of the underlying representation [@makin2017stability; @makin2023against]. Several observations motivate that challenge:

- Attempted movements of phantom fingers can evoke organized activity patterns resembling the intact hand representation, suggesting that the missing hand's functional organization persists.
- Stimulation of residual nerves or somatosensory cortex can evoke sensations assigned to the missing hand, again implying that the representation remains accessible.
- Neighboring body parts already produce weak, overlapping activity outside the territory in which they dominate. When the missing hand can no longer be stimulated, a "winner-takes-all" map may make those pre-existing inputs look like newly invaded territory.
- Most foundational human studies were cross-sectional. Comparing amputees with controls after limb loss cannot reveal whether apparent differences were caused by amputation or were present beforehand.

The strongest direct test followed three adults before a planned arm amputation and for as long as five years afterward. Schone, Makin, and colleagues compared activity associated with the hand before surgery, the phantom hand after surgery, and the lips across both periods. They found stable hand and lip representations in primary sensorimotor cortex and no evidence that the lips had spread into the missing-hand territory [@makin2025stable].

The sample was necessarily small, but the longitudinal design addressed the central weakness of earlier human comparisons: the same brains were measured before and after the loss. The result directly challenges the claim that adult arm amputation ordinarily triggers large-scale invasion of the hand map by the neighboring face representation.

### What the disagreement concerns

The new evidence strongly challenges the strongest "takeover" account, but it does not establish that adult cortex is static. Several different phenomena have often been grouped under the word *reorganization*:
...
These processes need not rise and fall together. A neuron may respond more strongly to a neighboring body part because a previously weak input has been unmasked, not because the neuron's original circuitry has been erased and rebuilt. A preserved hand representation may also be read differently by later cortical regions after the hand is gone. Both outcomes are forms of plasticity, but neither requires wholesale reassignment of cortical identity.

The evidence also comes from different biological situations. Digit amputation, complete deafferentation, congenital absence of a limb, temporary disuse, and surgical amputation in adulthood are not interchangeable interventions. Developmental input-dependence is especially important to separate from adult injury. The developing cortex can be strongly shaped by its inputs without implying that an adult map can be reassigned to a new body part on the same scale.
...
::: {.callout-note title="The body you feel is a model, and you can fool it"}
