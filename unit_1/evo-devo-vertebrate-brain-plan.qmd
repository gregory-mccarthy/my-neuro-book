...
The answer is that the most interesting differences between closely related brains are often differences in **regulation**: not new proteins, but changes in *when*, *where*, *how long*, and in *what order* shared proteins get switched on during development. When evolution remodels a brain, it more often changes the construction schedule than invents a new brick. There are exceptions. Some genuinely new genes and gene duplications have been recruited into primate and human brain development. But those exceptions do not overturn the main story. The deep story is not that evolution keeps inventing new brain parts from scratch. The deep story is that evolution alters the developmental programs that build brains.
...
## The Triune Brain {#sec-evo-devo-triune}
...
![A comparison of vertebrate brains including fish, amphibians (frog), reptile (lizard), and mammals (mouse, cat, human) (see @sec-image-credits-vertebrate-brains).](figs/vertebrate-brains.jpeg){#fig-vertebrate-brains width=90%}
...
The second is **mosaic evolution**. Within that integrated system, particular regions can still be expanded, reduced, delayed, accelerated, rewired, or elaborated. A lineage that relies heavily on electroreception may expand cerebellar and electrosensory circuitry. This can be seen in the expansion of the cerebellum in the morymid electric fish in @fig-vertebrate-brains. A lineage that relies heavily on vision may expand visual structures. A lineage whose survival depends on long learning in a complex social environment may stretch development and expand association circuitry. The whole brain evolves as a coordinated system, but not all parts change equally.
...
![Embryological sequence. See text for details (see @sec-image-credits-blastula).](/unit_1/figs/blastula.jpeg
){#fig-blastula width=90%}
...
Picture the tube lying on a table. The side resting on the table is the **ventral** side; the side facing up is the **dorsal** side. Along this **dorsal–ventral axis**, the walls of the tube acquire different molecular identities. A useful first division is between the dorsal **alar plate** and the ventral **basal plate**, separated on each side by a shallow longitudinal groove called the **sulcus limitans**.

In the spinal cord, the functional consequence is especially clear. The alar plate develops primarily into territory that receives and processes sensory information, whereas the basal plate develops primarily into motor territory. Sensory information enters the spinal cord dorsally; motor commands leave ventrally. This dorsal sensory–ventral motor organization is one of the basic architectural facts of the vertebrate nervous system.

The molecular basis of this distinction is a set of opposing developmental signals. From the ventral side, **Sonic hedgehog** diffuses from the notochord and floor plate. From the dorsal side, **BMPs** and related signals help specify dorsal identities. Cells respond not simply to the presence or absence of one signal but to combinations, concentrations, and timing. High Sonic hedgehog exposure promotes ventral identities, including motor-neuron lineages, whereas dorsal signals promote other neuronal fates. Long before the mature nuclei and pathways are visible, the tube has become a molecular landscape.

Now add the second coordinate. The neural tube is also patterned along its length — its **anterior–posterior axis**, equivalently rostral ("toward the beak") to caudal ("toward the tail"). The developing nervous system contains a series of molecularly distinct territories or **neuromeres** along this axis. In the hindbrain and spinal cord, **Hox genes** are especially important for assigning positional identity. Other transcription factors, including Otx, Gbx, Pax, Dlx, Emx, and many others, help define territories farther anteriorly.

The two systems together give every patch of the neural tube something like a two-dimensional molecular address. A progenitor cell is not simply "neural." It occupies a particular anterior–posterior level and a particular dorsal–ventral position, has experienced a particular history of morphogens, and expresses a particular combination of regulatory genes. That developmental history constrains what kinds of neurons it can generate, where those neurons can migrate, which molecular programs they express, and which circuits they can eventually join.

This is the key developmental idea of the chapter. The brain is not carved into parts after the fact. Its parts arise because the early neural tube is assigned molecular identities, and those identities regulate proliferation, migration, differentiation, and connectivity. When evolution changes the timing, strength, or boundaries of one of these developmental systems, it can change the adult brain.

## The old tube is still visible in the adult nervous system

The alar–basal distinction is easiest to recognize in the spinal cord, but it does not simply disappear when the spinal cord becomes brainstem. Instead, the geometry of the developing tube changes, and the original pattern is transformed with it.

In the spinal cord, the neural tube remains relatively closed. The lumen becomes the narrow **central canal**, with alar-derived sensory territory dorsally and basal-derived motor territory ventrally. If development stopped there, the rule would be wonderfully simple: dorsal sensory, ventral motor.

The hindbrain changes the geometry. As the **rhombencephalon** develops, its dorsal roof becomes thin and spreads apart. The lumen opens widely to form the **fourth ventricle**. Imagine opening the back of a tube like the covers of a book: tissue that began dorsally swings outward toward the sides. Alar-derived territories therefore come to lie more **laterally**, while basal-derived territories remain relatively **medial**.

![Opening of the hindbrain transforms the neural tube’s dorsal–ventral organization. Panel A shows the closed neural tube, in which the dorsal alar plate is associated with sensory-related development and the ventral basal plate with motor-related development; the sulcus limitans separates these territories. Panels B and C show the dorsal hindbrain opening as the roof plate widens and the neural-tube lumen expands to form the fourth ventricle. This morphogenetic change displaces alar-derived territory laterally while basal-derived territory remains relatively medial. Panel D shows the resulting organization of cranial-nerve nuclei in the adult hindbrain: motor nuclei derived from basal-plate territories lie medially, whereas sensory nuclei derived from alar-plate territories lie more laterally. Thus, the apparently different medial–lateral organization of the adult brainstem can be understood as a transformed version of the original dorsal–ventral pattern of the neural tube.](/unit_1/figs/hindbrain.jpeg){#fig-evo-devo-hindbrain}

This transformation explains an anatomical fact that otherwise looks arbitrary. In much of the adult brainstem, cranial-nerve **motor nuclei** tend to lie relatively medially, whereas **sensory nuclei** lie more laterally. The arrangement is not a new plan invented for the hindbrain. It is the old dorsal sensory–ventral motor organization of the neural tube, reshaped by the opening of the fourth ventricle.

The midbrain preserves the original tube in a different way. Here the lumen does not open broadly. Instead, it narrows into the **cerebral aqueduct**. That tiny channel is therefore an extraordinarily useful landmark: it is the surviving lumen of the mesencephalic neural tube.

Dorsal to the aqueduct lies the **tectum**, the "roof" of the midbrain. Its prominent adult structures, the superior and inferior colliculi, develop from dorsal midbrain territory. Ventral to the aqueduct lies the **tegmentum**, containing motor-related, modulatory, and integrative structures. Once again, development makes adult anatomy less arbitrary. The colliculi do not merely happen to sit on top of the midbrain. They are elaborations of its dorsal wall.

![Developmental organization of the midbrain. Panel A shows a transverse section through the embryonic mesencephalon, in which dorsal alar and ventral basal territories surround the neural-tube lumen. Panel B shows how dorsal alar territory expands to form the tectum, with rostral and caudal regions giving rise to the superior and inferior colliculi, while the central lumen narrows to become the cerebral aqueduct. Panel C shows an adult midbrain section at the level of the superior colliculus. The cerebral aqueduct remains a useful landmark for reconstructing the original neural-tube organization: the tectum lies dorsal to the aqueduct, whereas the tegmentum lies ventral to it and contains structures including the oculomotor nucleus and red nucleus. The substantia nigra and cerebral peduncles lie still farther ventrally. Thus, although development substantially transforms the mesencephalon, the position of the aqueduct preserves a visible trace of the original dorsal–ventral organization of the neural tube.](/unit_1/figs/midbrain.jpeg){#fig-evo-devo-midbrain}

This gives a useful anatomical strategy. In an unfamiliar midbrain section, find the aqueduct first. You have found the old lumen of the neural tube. The tectum is dorsal to it; the tegmentum is ventral to it. Development has become a coordinate system for reading adult anatomy.

But this simple correspondence has limits. **Alar does not mean "sensory forever," and basal does not mean "motor forever."** The terms describe embryonic territories and developmental histories, not permanent functional labels attached to every descendant cell. As the brain develops, territories expand, cells migrate, structures fold, and neurons born in different places converge into common adult circuits.

::: {.callout-note collapse="true"}
## Deeper Dive: How far does the alar–basal map take us?

The dorsal–ventral organization of the neural tube is real and deeply conserved. It is also easiest to overinterpret precisely because the spinal cord presents such a clean case. There, alar territory is strongly associated with sensory processing and basal territory with motor output. If we carry those equations unchanged into the rest of the brain, however, they begin to mislead us.

The **cerebellum** provides an immediate warning. Much of the cerebellar system develops from dorsal hindbrain territory associated with the rhombic lip. That developmental origin does not make the adult cerebellum a "sensory structure." The cerebellum receives enormous amounts of sensory information, but it uses that information within circuits concerned with prediction, coordination, learning, timing, and the control of movement and other functions. "Alar-derived" is a statement about developmental lineage, not a one-word description of adult function.

The pons makes the limitation even clearer. Some neurons that eventually occupy the ventral pons are **not born there**. Neurons that contribute to the pontine nuclei arise in dorsal and caudal hindbrain germinal territories associated with the rhombic lip and then migrate long distances toward their adult position in the ventral pons. An anatomist looking only at the final adult position could therefore draw the wrong conclusion about where those neurons originated.

![Developmental origins of the cerebellum and pontine nuclei. Panel A shows a transverse section through the early metencephalon, with dorsal alar territory, ventral basal territory, the rhombic lips, sulcus limitans, and the expanding fourth ventricle. Panel B illustrates two distinct developmental trajectories. Rostral dorsal hindbrain tissue expands to form the cerebellar primordium, whereas neurons generated in the more caudal rhombic lip migrate long distances rostrally and ventrally to populate the pontine nuclei. Panel C shows the adult arrangement: the cerebellum lies dorsal to the fourth ventricle, while the pontine nuclei occupy the ventral basis pontis and send transverse pontocerebellar fibers toward the cerebellum. The figure emphasizes that embryonic origin does not rigidly determine adult position or function: growth and neuronal migration substantially transform the original neural-tube map.](/unit_1/figs/pons.jpeg){#fig-evo-devo-pons}

This illustrates a more general developmental rule:

**Adult position is not necessarily birthplace.**

Migration changes a neuron's address more readily than it erases its developmental history. Before a young neuron migrates, its progenitor territory has already exposed it to particular signaling molecules and transcription-factor programs. That history can bias or specify important aspects of its identity — neurotransmitter phenotype, receptor and ion-channel expression, axon-guidance programs, and the range of neuronal subtypes it can become. Signals encountered during migration and at the final destination then further shape its mature morphology, physiology, connections, and function.

Adult structures can therefore be mosaics assembled from cells with different developmental histories. Two neighboring neurons in the mature brain need not have been born next to each other, and cells born in a common progenitor territory need not remain together.

This principle becomes especially important in the forebrain. Dorsal–ventral patterning still matters there, but **alar plate versus basal plate is no longer the most useful vocabulary for introductory anatomy**. In the telencephalon, a more informative distinction is between the dorsal **pallium** and ventral **subpallium**. Pallial progenitors generate much of the cerebral cortex and its excitatory projection neurons. Subpallial progenitors generate the basal ganglia and many inhibitory interneurons. Many of those interneurons then migrate long distances from the ventral telencephalon into the developing cortex.

So the developmental principle does not disappear as we move rostrally. What changes is the usefulness of the simple anatomical labels. The spinal cord preserves the original dorsal–ventral map almost transparently. The hindbrain opens and converts much of that organization into a medial–lateral one. The midbrain retains the aqueduct as a visible landmark of the original tube. Farther forward, differential growth, new developmental territories, migration, and folding increasingly obscure the simple geometry.

The lesson is therefore not that every adult brain structure can be classified as "alar" or "basal." The stronger lesson is that **adult anatomy is the transformed product of patterned progenitor territories**. Knowing the starting map can explain the mature arrangement — but only if we also follow what development does to the map.
:::
...
![The patterning of the neural tube as visualized in a developing embryo. See text for details (@sec-image-credits-embryo).](figs/embryo.png){#fig-embryo width=90%}
...
Now we can return to heterochrony with a better substrate in mind. The brain begins as a patterned tube. Its territories are defined by gene-expression domains, organizers, gradients, and segmental addresses. Those territories then proliferate, bend, migrate, differentiate, connect, and refine themselves. If evolution alters the timing of those events, it can alter the adult brain.
...
After a chapter spent emphasizing uncertainty, it is worth tallying the ledger — because the column of things we *are* sure of is long.
