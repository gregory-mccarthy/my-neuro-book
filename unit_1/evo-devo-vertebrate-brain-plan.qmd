...
This is especially clear in development. The same signaling pathway can be reused in many organs. Sonic hedgehog helps pattern the dorsal-ventral axis of the neural tube, but it also contributes to limb patterning, tooth development, and other embryonic processes. Pax6 is famous for its role in eye development across animals, but it also helps pattern the telencephalon. Developmental mechanisms are promiscuously reused.
