...
## The vagus nerve {#sec-embodied-brain-vagus}
...
## Breaching the barrier: the circumventricular organs {#sec-embodied-circumventricular}
...
![**Circumventricular organs provide specialized interfaces between the blood and the brain.** In this midsagittal view, the subfornical organ (SFO), organum vasculosum of the lamina terminalis (OVLT), and area postrema are sensory circumventricular organs that detect blood-borne signals. The median eminence and pineal gland, or pineal body, are secretory circumventricular organs that release signals into the circulation. These structures possess fenestrated capillaries and specialized barrier arrangements that permit forms of blood–brain exchange that are sharply restricted across most of the brain. Locations and proportions are schematic.](figs/circumventricular.jpeg){#fig-embodied-circumventricular fig-alt="Schematic midsagittal view of the brain showing the locations of the subfornical organ, OVLT, median eminence, pineal gland, and area postrema."}
...
### The third job: clearance

The brain's blood vessels help organize the clearance of waste. Every active tissue makes trash. Neurons and glia generate ions, neurotransmitter breakdown products, misfolded proteins, inflammatory molecules, and ordinary metabolic by-products that cannot simply accumulate in the extracellular space. This third job of the vascular system intersects with our discussion of the brain's glymphatic and lymphatic systems that will be discussed in detail in @sec-glymphatic.


::: {.callout-note}
## Following the energy — neurovascular coupling, PET and fMRI
...
A more detailed look at the methods used in human neuroscience research can be found in @sec-appendix-methods.
:::
...
## Brain drainage: glymphatic flow, meningeal lymphatics, and the skull {#sec-glymphatic}
...
::: {.callout-note collapse="true"}
## Deeper Dive: The skull as part of the brain's immune border
...
## Coda: the machinery on which prediction runs
...
Which brings us, finally, to the structures themselves. We have spent this chapter on how the brain *talks to* the body — the channels in and out. We have deliberately deferred the brain's internal organization: what the hypothalamus actually contains, how the cortex is arranged, what the cerebellum and basal ganglia and amygdala are doing, how the great fiber tracts wire the regions to each other. That is the subject of the next chapter, **@sec-connected-map — an anatomical tour of the human brain**. Now that we understand the brain as an embodied controller — wired into the body it regulates — we are ready to tour the machinery that does the regulating, and to ask of each structure not merely "what is it called?" but "what is its *role*?"
