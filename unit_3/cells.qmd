---
title: "Chapter 3.1 — The Cells of the Brain"
...
<!--
Quarto note: collapsible "deeper dive" sections use a fenced callout div:
...
The brain is made of cells. That sounds too obvious to say, but it is the right place to begin because the brain is not made of one kind of cell. It is an organized tissue containing two broad cellular families: **neurons** and **glia**.
...
## The neuron doctrine, and where it leaks

The idea that the brain is built from discrete neurons — separate cells, not a continuous fused network — was not obvious and was hard-won. In the late nineteenth century two great anatomists looked at the same kind of stained tissue and drew opposite conclusions. **Camillo Golgi** had invented the silver-impregnation stain that, for reasons still not fully understood, blackens a small random fraction of neurons in their entirety, revealing their full shape against a clear background. Golgi himself, looking at these images, concluded that the nervous system was a continuous reticulum — a fused web in which the processes of different cells joined into one network. **Santiago Ramón y Cajal**, using Golgi's own stain with extraordinary patience and artistry, came to the opposite and correct view: that neurons are *discrete cells*, contacting one another closely but not fusing into one continuous cytoplasm. The two shared the Nobel Prize in 1906 and, famously, used their joint lecture to argue against each other.

Cajal's view became the **neuron doctrine**. In its classical form, the doctrine says that the neuron is the fundamental structural and functional unit of the nervous system; that neurons are discrete cells rather than a continuous network; that each consists of specialized parts such as dendrites, soma, and axon; and that information flows through the cell in a directional way. This doctrine is the foundation on which modern neuroscience was built, and it is essentially correct.

It is also incomplete, which is not a criticism. It is what happens to all good biological principles when they meet biology. **Electrical synapses**, formed by gap junctions, couple the interiors of two neurons directly, and current can pass through them in both directions. **Retrograde transmission** runs signals backward across the chemical synapse, from the postsynaptic cell to the presynaptic one, a mechanism we will meet again when we discuss synaptic plasticity. **Dendritic computation** turns out to be real: some dendrites do not merely funnel inputs passively to the soma but perform local electrical operations of their own. The neuron is less like a single summing point than like a tree of semi-independent compartments, some of which can make decisions before the soma ever sees the result.

None of this overturns the neuron doctrine. It enriches it. The doctrine gives us the cellular unit. The leaks remind us not to mistake the first approximation for the full machine.
...
This is also where radial glia deserve their first serious mention. They are called glia, but in development they are not merely support cells. They generate neurons and glia, provide scaffolds for migration, and then, in many regions, transform into astrocytic lineages. Development keeps making the same point: the categories are real, but the boundaries are not as tidy as textbook tables make them look.
