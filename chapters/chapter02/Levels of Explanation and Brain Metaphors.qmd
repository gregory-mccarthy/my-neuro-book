...
A thermostat regulates one thing: temperature. Even here, however, arbitration is needed — we trade off between the cost of fuel and our comfort. Organisms face this challenge multiplied many times over: hunger, thirst, fatigue, thermoregulation, reproduction, defense, social affiliation. These drives cannot all be satisfied simultaneously. The brain’s challenge is not only regulation but **arbitration**: deciding what to regulate now and at what cost to other goals.  
...
- Even in our simple thermostat example, we have to balance **comfort vs. fuel cost**.  
