...
<!-- Suggested later placement for the overview SVG: figs/energy-balance-circuit.svg -->
...
<!-- Suggested later placement for the detailed SVG: figs/arc-melanocortin-circuit.svg -->
